        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <section className="hidden lg:block">
            ...
            <h1 className="mt-4 text-5xl font-bold tracking-tight text-gray-900 leading-tight">
              Create your account and join the rental marketplace.
            </h1>
            <p className="mt-5 text-lg text-gray-600 max-w-xl">
              List products, connect with local renters, and manage everything from one powerful workspace.
            </p>
          </section>
          ...
          <section className="bg-white border border-gray-100 rounded-3xl shadow-xl p-6 sm:p-10">
            ...
            <p className="mt-1 text-sm text-gray-500">Set up your profile in less than a minute.</p>
